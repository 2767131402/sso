...
//import com.macro.cloud.mapper.OauthClientDetailsMapper;
...
//        OauthClientDetails model = oauthClientDetailsMapper.getOauthClientDetailsByClientId(clientId);
//        if (model == null) {
//            return null;
//        }
...
//        clientDetails.setClientSecret(passwordEncoder.encode(model.getClientSecret()));//客户端(client)的访问密匙
